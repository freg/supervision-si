...
HEADER_SYNONYMS = {
    ...
    "production_state": ("prod state", "production state", "productionstate", "prodstate", "état de production", "etat", "state"),
    "hw_manufacturer": ("hw manufacturer", "hardware manufacturer", "manufacturer", "constructeur", "hwmanufacturer"),
    "hw_product": ("hw product", "hardware product", "hardware", "model", "modèle", "modele", "product", "hwproduct", "hw product name", "productname"),

...
if (file_exists("../db/maintenanceFunctions.php")) include_once "../db/maintenanceFunctions.php";
...
if ($habilitation->allowAccess != 1) {
  echo 'Call to loadPlugin.php for non allowed user.<br/>This action and your IP has been traced.';
  traceHack('Call to loadPlugin.php for non allowed user');
	exit;
}

...
foreach ($termList as $term)
{
    ...
    echo '
            <tr>
                ...
                if($bill->id){
                    echo'<td class="reportTableData"><img src="../view/img/checkedOK.png" width="12" height="12" /></td>';
                }else{
                    echo'<td class="reportTableData"><img src="../view/img/checkedKO.png" width="12" height="12" /></td>';
                }

...
$idBaseline="";
if (pq_array_key_exists('idBaselineSelect',$_REQUEST) and pq_trim($_REQUEST['idBaselineSelect'])!="") {
  $idBaseline=pq_trim($_REQUEST['idBaselineSelect']);
...
$title.=" : ".pq_str_replace('&nbsp;',' ',Work::displayWorkWithUnit(abs($workGap)));

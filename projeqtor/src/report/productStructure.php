...
if (pq_array_key_exists('objectClass', $_REQUEST)){
  $objectClass=pq_trim($_REQUEST['objectClass']);
}
Security::checkValidClass($objectClass);
$objectId="";
if (pq_array_key_exists('objectId', $_REQUEST)){
  $objectId=pq_trim($_REQUEST['objectId']);
}
...
if (pq_array_key_exists('showVersionsForAll', $_REQUEST)){
...
if (pq_array_key_exists('showProjectsLinked', $_REQUEST)){
...
if (pq_array_key_exists('showClosedItems', $_REQUEST)){

...
class OneLogin_Saml2_Utils
{
    ...
    protected static function getRawHost()
    {
        ...
        } elseif (self::getProxyVars() && pq_array_key_exists('HTTP_X_FORWARDED_HOST', $_SERVER)) {
            $currentHost = $_SERVER['HTTP_X_FORWARDED_HOST'];
        } elseif (pq_array_key_exists('HTTP_HOST', $_SERVER)) {
            $currentHost = $_SERVER['HTTP_HOST'];
        } elseif (pq_array_key_exists('SERVER_NAME', $_SERVER)) {

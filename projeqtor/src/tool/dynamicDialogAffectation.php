  ...
  <table>
         ...
         <table>
           ...
           <tr>
             ...
             <td>
               ...
               <?php 
                  $multiCapable = ($class=="Project" and $mode=="add" and !$isTeam and !$isOrganization and $type!="Contact" and $type!="User");
                  if($multiCapable){?> 
                  	onChange="affectationResourceOnChange();"<?php
                  }else if(!$isTeam and !$isOrganization){?> 
                  	onChange="affectationChangeResource();"<?php } ?>
                  	
             			class="input <?php echo ($objTeam=="Team" or $objTeam=="Organization" or $multiCapable)?'':'required';?>" 
             			value="<?php if($class=="Project" && $type=="Resource"){ 
                           			 echo $affectation->idResource;
                           		} else if($class=="Project" && $type=="Contact"){ 
                           			 echo $affectation->idContact;
             			            } else{ echo $idResource;}?>"
             <?php echo ($objTeam=="Team" or $objTeam=="Organization")?"required=false":"";?> <?php echo ($class!="Project")?"readonly=readonly":"";?> style="font-family: Verdana, Arial, Tahoma, sans-serif, icomoon;">
                         ...
                         htmlDrawOptionForReference('idTeam', null,$obj,false,null,null);
                          ...
                          htmlDrawOptionForReference('idResourceAllNoMaterial', $idResource, null,false,null,null,null,null,null,null,null,true);
                       }
                 ?>
               </div> 
             </td>
               ...
               <td style="vertical-align: top">
                 <button id="affectationDetailButton" dojoType="dijit.form.Button" showlabel="false"
                   ...
                   <script type="dojo/connect" event="onClick" args="evt">
                    ...
                    <?php if($isTeam){?>
                           showDetail('affectationResource', canCreate , 'Team', false);
                    <?php }else if($isOrganization){ ?>
                           showDetail('affectationResource', canCreate , 'Organization', false);
                    <?php }elseif($type=="ResourceAll"){?>
                           showDetail('affectationResource', canCreate , 'ResourceAllNoMaterial', <?php echo ($multiCapable)?'true':'false';?>);
           ...
           <?php if($multiCapable){?>
            <tr>
              <td>&nbsp;</td>
              <td>
                <div id="affectationResourceChips" class="affectationResourceChips"></div>
                <input type="hidden" id="affectationResourceList" name="affectationResourceList" value="" />
              </td>
            </tr>
            <?php }?>
           <tr id="affectationToProfile" name="affectationToProfile"  >
             ...
             <td>
               ...
               <?php echo autoOpenFilteringSelect();?>
                ...
                class="input <?php echo ($objTeam=="Team" or $objTeam=="Organization" or $objTeam=="ResourceTeam" or $objTeam=="ResourceMaterial" or $isTeam or $isOrganization)?'':'';?>"  value="<?php 
               ...
               <?php echo ($objTeam=="Team" or $objTeam=="Organization" or $objTeam=="ResourceTeam" or $objTeam=="ResourceMaterial" or $isTeam or $isOrganization) ?"required=false":"required=false";?> <?php //echo ($objTeam=="Team" or $objTeam=="Organization")?"readonly=readonly":"";?>>
    ...
    <tr>
      <td align="center">
        ...
        <button class="mediumTextButton" dojoType="dijit.form.Button" type="button" onclick="resetAffectationResourceChips();dijit.byId('dialogAffectation').hide();">

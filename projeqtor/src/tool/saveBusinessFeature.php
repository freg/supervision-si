...
// Get the link info
if (! pq_array_key_exists('businessFeatureObjectClass',$_REQUEST)) {
...
if (! pq_array_key_exists('businessFeatureObjectId',$_REQUEST)) {
...
if (! pq_array_key_exists('businessFeatureName',$_REQUEST)) {

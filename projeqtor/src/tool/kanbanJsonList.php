...
if (!$param or !class_exists($param)) {
	echo '{"identifier":"id","label": "name","items":[]}';
	return;
}
...
if(Module::isModuleActive('moduleTargetMilestone')){
  if (property_exists($obj, 'idMilestone')){
    $JsonData .= ',{"id":"Milestone" , "name":"'. i18n("colIdTargetMilestone") .'"}';
  }
}
$JsonData.= ' ]}';
echo  $JsonData;

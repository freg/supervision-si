...
foreach ($selectListSorted as $id) {
	...
	echo '<tr class="trDeleteObjectMultiple">';
  ...
  echo '<td class="tdDeleteObjectMultiple"><div style="" class="message'.$statusSave.'" >' . $resultSave . '</div></td>';
  echo '</tr>';
}
echo "</table>";
$summary="";
...
echo '<input type="hidden" id="summaryResult" value="'.$summary.'" />';
if ($cptOk>0 and $className=='Project') {

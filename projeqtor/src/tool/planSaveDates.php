...
if (! pq_array_key_exists('idProjectPlanSaveDates',$_REQUEST)) {
...
if (! pq_array_key_exists('updateValidatedDates',$_REQUEST)) {
...
if (! pq_array_key_exists('updateInitialDates',$_REQUEST)) {

...
//       }
//     }
//     if (! $successor->fixPlanning and ! PlanningMode::isFixed($successor->idPlanningMode)) $resSuccessor=$successor->save();
//   }
// }
$arrayChanged=array();
...
if (pq_stripos($result,'id="lastOperationStatus" value="ERROR"')>0 ) {	
  ...
  $result=pq_substr($result,0,pq_strpos($result,'<input'));

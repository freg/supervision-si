...
if ($mode=='add') {
  if (! pq_array_key_exists ( 'callForTenderId', $_REQUEST )) {
  ...
  if (! pq_array_key_exists ( 'tenderId', $_REQUEST )) {
			...
			<td>
				<form dojoType="dijit.form.Form" id='dialogTenderSubmissionForm'
                 ...
                 <?php if ($tender->idProvider) htmlDrawOptionForReference('idContact', $tender->idContact, null, false,'idProvider',$tender->idProvider);
                  ...
                  value="<?php if ($tender->requestDateTime) echo pq_substr($tender->requestDateTime,0,10);?>">
                 </div>
                 <div id="dialogCallForTenderSubmissionRequestTime" name="dialogCallForTenderSubmissionRequestTime"
                  ...
                  value="T<?php echo pq_substr($tender->requestDateTime,11,5);?>">
                 </div>
						  </td>
						</tr>
						<tr>
                  ...
                  value="<?php if ($tender->expectedTenderDateTime) echo pq_substr($tender->expectedTenderDateTime,0,10);?>">
                 </div>
                 <div id="dialogCallForTenderSubmissionExpectedTenderTime" name="dialogCallForTenderSubmissionExpectedTenderTime"
                  ...
                  value="T<?php echo pq_substr($tender->expectedTenderDateTime,11,5);?>">
                 </div>
						  </td>
						</tr>
						<tr>

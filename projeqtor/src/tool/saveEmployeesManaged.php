...
if (! pq_array_key_exists('idEmployeesManaged',$_REQUEST)) {
  throwError('idEmployeesManaged parameter not found in REQUEST');
}
$idEmployeesManaged = $_REQUEST['idEmployeesManaged'];

if (! pq_array_key_exists('idEmployeeManagerEmployeesManaged',$_REQUEST)) {

...
?>
  ...
  <?php if ($isIE and $isIE<=9) {?>
    action="../tool/saveDocumentVersion.php?isIE=<?php echo ($isIE?1:0); echo Security::addTokenIndexToUrl()?>"
    target="documentVersionPost"
    onSubmit="return saveDocumentVersion();"
  <?php }?> 
  >
  <div id="formDivDoc" dojoType="dijit.layout.ContentPane" region="center" style="overflow:auto" 
	  ondragover="dropFilesFormOnDragOverDocument();" 
	  ondrop="dropFilesFormOnDropDocument();"  >
  <div id="dropFilesDocInfoDiv" style="pointer-events: none;top:37px;margin:5px;display:none;" ondrop="return false;" >
    <div style="position:absolute;top:50%;margin-top:-25px;height:px;width:100%;text-align:center;style="pointer-events: none;"><?php echo i18n('dragAndDropDocuments');?></div>
  </div>
      ...
      <tr height="30px"> 
        ...
        <td style="position:relative">
         ...
         <input MAX_FILE_SIZE="<?php echo Parameter::getGlobalParameter('paramAttachmentMaxSize');?>"
          ...
          url="../tool/saveDocumentVersion.php<?php echo Security::addTokenIndexToUrl('?'); ?>"
          name="documentVersionFile" id="documentVersionFile" 
          cancelText="<?php echo i18n("buttonReset");?>"
          <?php if (! $isIE) {?>

...
$lineId=null;
if (pq_array_key_exists('jobDefinitionId',$_REQUEST)) {
...
$lineName=null;
if (pq_array_key_exists('dialogJobDefinitionName',$_REQUEST)) {
	$lineName=$_REQUEST['dialogJobDefinitionName'];
}
$lineTitle=null;
if (pq_array_key_exists('dialogJobDefinitionTitle',$_REQUEST)) {
	$lineTitle=$_REQUEST['dialogJobDefinitionTitle'];
}
$sortOrder=0;
if (pq_array_key_exists('dialogJobDefinitionSortOrder',$_REQUEST)) {
	$sortOrder=$_REQUEST['dialogJobDefinitionSortOrder'];
}
$daysBeforeWarning=0;
if (pq_array_key_exists('dialogJobDefinitionDaysBeforeWarning',$_REQUEST)) {

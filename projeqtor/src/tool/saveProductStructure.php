...
// Get the link info
if (! pq_array_key_exists('productStructureObjectClass',$_REQUEST)) {
...
if (! pq_array_key_exists('productStructureObjectId',$_REQUEST)) {
...
if (! pq_array_key_exists('productStructureListClass',$_REQUEST)) {
...
if (! pq_array_key_exists('productStructureWay',$_REQUEST)) {
...
if (! pq_array_key_exists('productStructureListId',$_REQUEST)) {
  throwError('productStructureListId parameter not found in REQUEST');
}
$listId=$_REQUEST['productStructureListId'];

$comment="";
if (pq_array_key_exists('productStructureComment',$_REQUEST)) {
    $comment=$_REQUEST['productStructureComment'];
}

$strId=null;
if (pq_array_key_exists('productStructureId',$_REQUEST)) {

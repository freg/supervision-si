...
if(! pq_array_key_exists ( 'idGenericBankOffDays', $_REQUEST )){
...
if(! pq_array_key_exists ( 'idCalendarDefinition', $_REQUEST )){
...
if($editMode==="true"){
    ...
    if(! pq_array_key_exists ( 'day', $_REQUEST )){
                        ...
                        <tr>
                            ...
                            <td>
                                <select id="genericBankOffDayEasterDay"  dojoType="dijit.form.Select"
                                        ...
                                        class="input" 
                                        value="<?php 
                                            $theEasterDay = ($easterDay==null?5:$easterDay);
                                            echo $theEasterDay;
                                               ?>">

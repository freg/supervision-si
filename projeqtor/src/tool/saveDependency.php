...
if (! pq_array_key_exists('dependencyRefIdDep',$_REQUEST)) {
  if (! pq_array_key_exists('dependencyId',$_REQUEST)) {
...
$dependencyDelay=0;
if (pq_array_key_exists('dependencyDelay',$_REQUEST)) {
...
// PBER #11867 - plannedDate should not be moved out of planning calculation
//	  if ($tmpStatus=='OK' and ! PlanningMode::isFixed($successor->idPlanningMode) ) {

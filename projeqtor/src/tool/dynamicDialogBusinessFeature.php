...
if ( pq_array_key_exists('businessFeatureId',$_REQUEST)) {
      ...
      <form id='businessFeatureForm' name='businessFeatureForm' onSubmit="return false;">
        ...
        <table>
          ...
          <tr>
            ...
            //New ?>
            <input style="width:500px;"dojoType="dijit.form.TextBox"  size="100" id="businessFeatureName" name="businessFeatureName" value="<?php echo $bf->name;?>"  onkeyup="enableWidget('dialogBusinessFeatureSubmit');" />

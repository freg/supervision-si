...
if (! pq_array_key_exists('colName',$_REQUEST)) {
  throwError('colName parameter not found in REQUEST');
}
$colName = $_REQUEST['colName'];

if (! pq_array_key_exists('idNotificationDefinition',$_REQUEST)) {
...
if (! pq_array_key_exists('everyMonth',$_REQUEST)) {
  throwError('everyMonth parameter not found in REQUEST');
}
$everyMonth = $_REQUEST['everyMonth'];

if (! pq_array_key_exists('everyYear',$_REQUEST)) {

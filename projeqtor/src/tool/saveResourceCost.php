...
$id=null;
if (pq_array_key_exists('resourceCostId',$_REQUEST)) {
  $id=pq_trim($_REQUEST['resourceCostId']);
}
if ($id=='') {
  $id=null;
}
...
if (! pq_array_key_exists('resourceCostIdResource',$_REQUEST)) {
...
$idRole=null;
if (pq_array_key_exists('resourceCostIdRole',$_REQUEST)) {
  $idRole=$_REQUEST['resourceCostIdRole'];
}

if (! pq_array_key_exists('resourceCostValue',$_REQUEST)) {
  throwError('resourceCostValue parameter not found in REQUEST');
}
$value=$_REQUEST['resourceCostValue'];

$startDate=null;
if (pq_array_key_exists('resourceCostStartDate',$_REQUEST)) {
  $startDate=pq_trim($_REQUEST['resourceCostStartDate']);
}
if ($startDate=='') {
  $startDate=null;
}

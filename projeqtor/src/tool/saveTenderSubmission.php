...
if (! pq_array_key_exists('dialogCallForTenderSubmissionCallForTenderId',$_REQUEST)) {
...
if (! pq_array_key_exists('dialogCallForTenderSubmissionTenderId',$_REQUEST)) {
...
if (! pq_array_key_exists('dialogCallForTenderSubmissionProvider',$_REQUEST)) {
...
if (! pq_array_key_exists('dialogCallForTenderSubmissionContact',$_REQUEST)) {
...
if (! pq_array_key_exists('dialogCallForTenderSubmissionRequestDate',$_REQUEST)) {
...
if (! pq_array_key_exists('dialogCallForTenderSubmissionRequestTime',$_REQUEST)) {
...
$requestDateTime=$requestDate.' '.pq_substr($requestTime,1);
Security::checkValidDateTime($requestDateTime);

if (! pq_array_key_exists('dialogCallForTenderSubmissionExpectedTenderDate',$_REQUEST)) {
...
if (! pq_array_key_exists('dialogCallForTenderSubmissionExpectedTenderTime',$_REQUEST)) {
...
$expectedTenderDateTime=$expectedTenderDate.' '.pq_substr($expectedTenderTime,1);
Security::checkValidDateTime($expectedTenderDateTime);

if (! pq_array_key_exists('dialogCallForTenderSubmissionStatus',$_REQUEST)) {

...
<div class="container" dojoType="dijit.layout.BorderContainer" liveSplitters="false" style="width:800px; height:500px;">
	<div id="activityStreamTopBacklog" dojoType="dijit.layout.ContentPane" region="top" style="text-align:center" class="dijitAccordionTitle">
	  <span class="title" ><?php echo i18n("titleStream");?></span>
	</div>
	<div id="activityStreamCenterBacklog" dojoType="dijit.layout.ContentPane" region="center" style="overflow-x:hidden;">
	  <script type="dojo/connect" event="onLoad" args="evt">
        scrollInto();
	  </script>
	  <table id="objectStreamBacklog" style="width:100%;"> 
	    <?php foreach ( $notes as $note ) {
	      echo activityStreamDisplayNote ($note,"objectStreamBacklog");
	    };?>
	...
	if ($canUpdate) {
	?>
	<div id="activityStreamBottomBacklog" dojoType="dijit.layout.ContentPane" region="bottom" style="height:<?php echo (isNewGui())?'80':'70';?>px;overflow-x:hidden;">
	  <form id='noteFormStreamBacklog' name='noteFormStreamBacklog' onSubmit="return false;" >
       <input id="noteId" name="noteId" type="hidden" value="" />
       <input id="itemId" name="itemId" type="hidden" value="<?php echo $itemId;?>" />
       ...
       <input id="noteEditorTypeStreamBacklog" name="noteEditorTypeStreamBacklog" type="hidden" value="<?php echo getEditorType();?>" />
       <div style="width:99%;position:relative">
       <textarea rows="4"  name="noteStreamBacklog" id="noteStreamBacklog" dojoType="dijit.form.SimpleTextarea" tabindex="1"
         style="width:98.5%;height:60px;overflow-x:hidden;overflow-y:auto;border:1px solid grey;margin-top:2px;" tabIndex="-1" onclick="focusStream();" ></textarea>
         <?php
         $privacyClass="";

...
$joblistDefinitionId = pq_trim($_REQUEST['joblistDefinitionId']);
/* if (!pq_array_key_exists('joblistId', $_REQUEST)) {
  throwError('joblistId parameter not found in REQUEST');
  }
  $joblistId = pq_trim($_REQUEST['joblistId']); */
if (!pq_array_key_exists('joblistObjectClass', $_REQUEST)) {
    throwError('joblistObjectClass parameter not found in REQUEST');
}
$joblistObjectClass = $_REQUEST['joblistObjectClass'];
if (!pq_array_key_exists('joblistObjectId', $_REQUEST)) {
    throwError('joblistObjectId parameter not found in REQUEST');
}
$joblistObjectId = pq_trim($_REQUEST['joblistObjectId']);

...
if ($action=='ADD') {
    ...
    if(!pq_array_key_exists('scope', $_REQUEST)) {
        $error = array('scope');
    } else {    
    ...
    $scope='';
    if(!pq_array_key_exists('budgetWork', $_REQUEST)) {
        $error = array('budgetWork');
    } else {
        $budgetWork=$_REQUEST['budgetWork'];;        
    }
    if(!pq_array_key_exists('budgetCost', $_REQUEST)) {
        $error = array('budgetCost');
    } else {
        $budgetCost=$_REQUEST['budgetCost'];;        
    }    
    if(!pq_array_key_exists('budgetExpenseAmount', $_REQUEST)) {
...
$bdg=new BudgetElement();
$dataLength=$bdg->getDataLength('budgetCost');
$maxCost=pq_substr('99999999999999999999', 0, intval($dataLength));
$dataLength=$bdg->getDataLength('expenseBudgetAmount');
$maxAmount=pq_substr('99999999999999999999', 0, intval($dataLength));
$dataLength=$bdg->getDataLength('budgetWork');
$maxWork=pq_substr('99999999999999999999', 0, intval($dataLength));
?>
                ...
                <tr class="detail">
                    ...
                    <td>                        
                        <div id="AddChangeBudgetElementBudgetWork" name="AddChangeBudgetElementBudgetWork"
                             ...
                             constraints="{min:0,max:<?php echo $maxWork?>}" 
                ...
                <tr class="detail">
                    ...
                    <td>
                        ...
                        <div id="AddChangeBudgetElementBudgetCost" name="AddChangeBudgetElementBudgetCost"
                             dojoType="dijit.form.NumberTextBox" 
                             constraints="{min:0,max:<?php echo $maxCost?>}" 
                ...
                <tr class="detail">
                    ...
                    <td>
                        ...
                        <div id="AddChangeBudgetElementBudgetExpenseAmount" name="AddChangeBudgetElementBudgetExpenseAmount"
                             dojoType="dijit.form.NumberTextBox" 
                             constraints="{min:0,max:<?php echo $maxAmount?>}" 

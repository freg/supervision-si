...
$noteNote=RequestHandler::getValue("noteStreamBacklog",false);
...
<?php foreach ( $notes as $note ) {
	echo activityStreamDisplayNote ($note,"objectStreamBacklog");
	  ...
	  <div id="resultBacklogStreamDiv" style="display:block;position:fixed;z-index:9999;top:70px;left:50%;margin-left:-50px;">
		<?php displayLastOperationStatus($result);?>
		</div>
		<?php $nbBadge=(count ($notes) > 0)?count ($notes):'';?>
		<input type="hidden" id="countNoteItem" name="countNoteItem" value="<?php echo $nbBadge;?>" />
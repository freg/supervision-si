...
// Get the link info
if (! pq_array_key_exists('productVersionStructureObjectClass',$_REQUEST)) {
...
if (! pq_array_key_exists('productVersionStructureObjectId',$_REQUEST)) {
...
if (! pq_array_key_exists('productVersionStructureListClass',$_REQUEST)) {
...
if (! pq_array_key_exists('productVersionStructureWay',$_REQUEST)) {
...
if (! pq_array_key_exists('productVersionStructureListId',$_REQUEST)) {
  throwError('productVersionStructureListId parameter not found in REQUEST');
}
$listId=$_REQUEST['productVersionStructureListId'];

$comment="";
if (pq_array_key_exists('productVersionStructureComment',$_REQUEST)) {
    $comment=$_REQUEST['productVersionStructureComment'];
}
$strId=null;
if (pq_array_key_exists('productVersionStructureId',$_REQUEST)) {

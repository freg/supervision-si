...
// Get the link info
if (! pq_array_key_exists('originOriginType',$_REQUEST)) {
...
echo '<input type="hidden" id="originPlanningValue" value="'.htmlEncode($originOriginType.'#'.$originOriginId, 'attribute').'" />';
echo '<input type="hidden" id="originPlanningDisplayValue" value="'.htmlEncode(i18n($originOriginType).'#'.$originOriginId, 'attribute').'" />';

...
if($idFilterFromFavoriteProject){
  ...
  $flt=new Filter();
  $where ="refType='$objectClass' AND (idUser=$user->id OR isCommon=1)";
  $orderByFilter = "sortOrder ASC";
  $filterList=$flt->getSqlElementsFromCriteria(null,false,$where,$orderByFilter);
}
...
htmlDisplayStoredFilter($filterList,$filterObjectClass,$currentFilter, $context, $comboDetail, $idFilterFromFavoriteProject);

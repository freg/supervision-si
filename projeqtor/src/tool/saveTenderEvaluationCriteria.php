...
if (! pq_array_key_exists('dialogTenderCriteriaCallForTenderId',$_REQUEST)) {
...
if (! pq_array_key_exists('dialogTenderCriteriaId',$_REQUEST)) {
...
if (! pq_array_key_exists('dialogTenderCriteriaName',$_REQUEST)) {
  throwError('dialogTenderCriteriaName parameter not found in REQUEST');
}
$criteriaName=$_REQUEST['dialogTenderCriteriaName'];

if (! pq_array_key_exists('dialogTenderCriteriaMaxValue',$_REQUEST)) {
...
if (! pq_array_key_exists('dialogTenderCriteriaCoef',$_REQUEST)) {

...
if (! pq_array_key_exists('kpiThresholdId',$_REQUEST)) {
...
if (! pq_array_key_exists('kpiDefinitionId',$_REQUEST)) {
...
if (! pq_array_key_exists('kpiThresholdColor',$_REQUEST)) {

 ...
 */
  ...
  $topDetailDivHeight=getContentPaneSize('contentPaneTopPortfolioPlanningDivHeight');
 ...
 if($positonRightDiv=="bottom"){
   $rightHeightPortfolioPlanning=getHeightLayoutActivityStream($currentScreen);
 }else{

...
$searchByName = Parameter::getUserParameter('productBacklogSearchByName');
$searchByResponsible = Parameter::getUserParameter('productBacklogSearchByResponsible');
$searchByTargetProductVersion = Parameter::getUserParameter('productBacklogSearchByTargetProductVersion');
$orderBy = Parameter::getUserParameter('productBacklogOrderBy');

?>
<input type="hidden" name="objectClassManual" id="objectClassManual" value="ProductBacklog" />
<div class="container" dojoType="dijit.layout.BorderContainer" id="divProductBacklogAllContainer">
  <div id="productBacklogHeader" class="listTitle" style="z-index:3;overflow:visible;min-height:65px;"
    dojoType="dijit.layout.ContentPane" region="top">
    <table width="100%">
      <tr height="100%" style="vertical-align: middle;">
        <td style="width:50px;">          
          <div style="position:absolute;top:2px">
            <?php echo formatIcon('ProductBacklog',32,null,true);?>
          </div>
        </td>
        <td class="title" style="height:35px;">    
          <?php echo i18n('menuProductBacklog');?>
        </td>
      </tr>
      <tr>
      	<td colspan="2">
    			<div style="width:100%; margin: 0px 10px;">
    				<form dojoType="dijit.form.Form" id="productBacklogForm" action="" method="">
    					...
    					<?php echo i18n("colName");?> : <input dojoType="dijit.form.TextBox" onKeyUp="filterBacklog();saveDataToSession('productBacklogSearchByName', dojo.byId('searchByName').value, true);" class="dijit dijitReset dijitInline dijitLeft filterField rounded dijitTextBox" type="text" id="searchByName" value="<?php echo $searchByName;?>">
              <?php echo i18n("colResponsible");?> : 
              <select dojoType="dijit.form.FilteringSelect" class="input roundedLeft" 
                <?php echo autoOpenFilteringSelect ();?>
                style="width: 150px;" onChange="filterBacklog();saveDataToSession('productBacklogSearchByResponsible', this.value, true);" name="searchByResponsible" id="searchByResponsible"
              ...
              <?php echo autoOpenFilteringSelect ();?>
              onChange="filterBacklog();saveDataToSession('productBacklogSearchByTargetProductVersion', this.value, true);" name="searchByTargetProductVersion" id="searchByTargetProductVersion" 
...
//                 }else{
              ...
              <select dojoType="dijit.form.FilteringSelect" class="input roundedLeft" style="width:150px;margin-right:15px;"
                <?php echo autoOpenFilteringSelect ();?>
              	onChange="saveDataToSession('productBacklogOrderBy', this.value, true);filterBacklog(true);" name="productBacklogOrderBy" id="productBacklogOrderBy">
              ...
              <div style="float:right;padding-right:1%;">
                <div dojoType="dijit.form.DropDownButton"							    
                 id="extraButtonProductBacklog" jsId="extraButtonProductBacklog" name="extraButtonProductBacklog" 
                 ...
                 title="<?php echo i18n('extraButtons');?>">
                   <div dojoType="dijit.TooltipDialog" class="white" id="extraButtonProductBacklogDialog" tyle="position: absolute; top: 50px; right: 40%">        
                     <table style="margin:5px">
                       <tr style="width:100%;">
                        <td><?php productBacklogParameterList();?></td>
                       </tr>
                     </table>
                   </div>
                </div>
        ...
        <div dojoType="dijit.layout.ContentPane" id="productBacklogJsonData" jsId="productBacklogJsonData" style="display: none">
    	  	<?php include '../tool/jsonProductBacklog.php'; ?>
    		</div>
      	</td>
      </tr>
    </table>
  ...
  <div class="container" dojoType="dijit.layout.ContentPane" id="divBacklogContainer" region="center" style=" overflow-x:scroll;">
    <?php include "../view/productBacklogView.php";?>
  </div>
</div>
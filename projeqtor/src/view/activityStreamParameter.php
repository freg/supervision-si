...
$hideEmailsSent = Parameter::getUserParameter('hideEmailsSent');
...
$height='115';
if($showOnlyNotes!='YES' or !$selectedAuthor){
  $showDisplayInChatMode='NO';
}
if ($showOnlyNotes=='YES' and $selectedAuthor){
  $showDisplayInChatMode='YES';
  $height='145';
}
...
<div style="width: 100%; margin: 0 auto; padding-bottom: 2px; border-bottom: 1px solid #CCC;background-color:<?php echo (isNewGui())?'var(--color-background)':'#ffffff';?>">
      ...
      <tr>
		...
		<td valign="top" width="20%">
		  <table class="activityStreamFilter" >
	        ...
	        <tr>
	         <td style="width:10%" align="right"><?php echo pq_ucfirst(i18n('colIdAuthor'));?>&nbsp;:&nbsp;</td>
			 <td align="left" style="margin-top:10px;padding-right:20px">
	           <select title="<?php echo i18n('filterOnAuthor')?>" type="text" class="filterField roundedLeft inputParameter" dojoType="dijit.form.FilteringSelect"
                ...
                <input type="hidden" id="lastActivityStreamAuthorFilter" name="lastActivityStreamAuthorFilter" value="<?php echo $selectedAuthor;?>" /> 
              </td>
            </tr>
            <tr style="height:2px;"></tr>
            <tr>
              <td align="right">
                <?php echo pq_ucfirst(i18n('Team'));?>&nbsp;:&nbsp;
              </td>
		  ...
		  <table class="activityStreamFilter">		
			...
			<tr>
			 <td style="width:10%;" align="right">
			   <?php echo pq_ucfirst(i18n('colType'));?>&nbsp;:&nbsp;
			 </td>
			 <td align="left" style="margin-top:10px;padding-right:20px">
            ...
            <tr>
			  <td align="right" style="width:10%">
			   <?php echo pq_ucfirst(i18n('colId'));?>&nbsp;:&nbsp;
	          </td>
		      <td align="left" style="padding-right:20px;">
		       <div style="width:30px;font-size:8pt;" class="filterField rounded" dojoType="dijit.form.TextBox" value="<?php echo $activityStreamIdNote;?>"
                 type="text" id="activityStreamIdNote" name="activityStreamIdNote" onChange="refreshActivityStreamList();" <?php echo (pq_trim($selectedElementType)=="")?"readonly=readonly":"";?>>
                </div>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              <input type="hidden" id="hideEmailsSentValue" name="hideEmailsSentValue" value="<?php echo $hideEmailsSent;?>" /> 
              <td colspan="2" style="width:50%;white-space:nowrap;" align="right">
                <a onclick="hideEmailsSentStream();" href="#" style="cursor: pointer;display:flex;">
                   <?php echo i18n("hideEmailsSent");?>
                   <?php $displayHideEmailsSent=($hideEmailsSent=='YES')?'inline-block':'none';?>
                   <span id="hideEmailsSent" style="display:<?php echo $displayHideEmailsSent;?>;margin-left:10px;";><img src="css/images/iconSelect.png"/></span>
                 </a>
              </td>
            </tr>
		  </table>
          ...
          <table>
	        ...
	        <tr>
			  <td style="width:10%;white-space:nowrap;" align="left">
			     <?php echo pq_ucfirst(i18n('colDays'));?>&nbsp;:
		      </td>
			  <td align="left">		
...
<table width="100%">
	<tr height="32px">
		<td width="50px" <?php echo 'style="position:relative;top:2px;"';?> align="center"><?php echo formatIcon('ActivityStream', 32, null, true);?></td>
		<td><span class="title"><?php echo i18n('menuActivityStream');?>&nbsp;</span></td>
	</tr>
</table>

<div id="containerActcityStream" style="width: 100%; margin: 0 auto; height: <?php echo $height.'px';?>; padding-bottom: 2px; border-bottom: 1px solid #CCC;background-color:<?php echo  'var(--color-background)'?>">
  <form id="activityStreamForm" name="activityStreamForm">
		<table width="100%"  style="margin-left:10px;<?php echo 'position:relative;top:-29px;';?>">
			<tr>
         ...
         <table ><tr><td>
          ...
          <div class="iconSize32 iconEraser  imageColorNewGui" title=" <?php echo i18n('activityStreamResetParameters');?>" style="cursor:pointer;position:absolute;top:80px;left:100px;"  onClick="resetActivityStreamListParametersNewGui();refreshActivityStreamList();"></div>
				...
				<td valign="top" width="25%">
					<table >
						<tr>
						  <td > <div id ="filterElement" style="height:<?php echo ($showDisplayInChatMode!='YES')?'144':'174'; ?>px;text-align:center;writing-mode: vertical-rl; transform: rotate(180deg);border-left:1px solid;margin-right:15px;">
						  <strong><?php echo pq_ucfirst(i18n('filterOnElementActivityStream'));?></strong> </div>
						  </td>
						  <td>
        			 ...
        			 <td align="left" style="padding-right:20px;">
                      <div style="width:30px;font-size:8pt;" class="filterField rounded" dojoType="dijit.form.TextBox" value="<?php echo $activityStreamIdNote;?>"
                       type="text" id="activityStreamIdNote" name="activityStreamIdNote" onChange="refreshActivityStreamList();" <?php echo (pq_trim($selectedElementType)=="")?"readonly=readonly":"";?>>
  						...
  						<tr>						  
  							<td style="width:10%" align="right">
  							 <?php echo pq_ucfirst(i18n('colIdAuthor'));?>&nbsp;&nbsp;
  							</td>
  							<td align="left" style="margin-top:10px;padding-right:20px">
  							  <select title="<?php echo i18n('filterOnAuthor')?>" type="text" class="filterField roundedLeft inputParameter" dojoType="dijit.form.FilteringSelect"
                  <?php echo autoOpenFilteringSelect();?> style="width:<?php echo $inputWidth;?>px;"
       ...
       <td valign="top" width="20%">
        <table >
          ...
          <input type="hidden" id="activityStreamUpdatedRecently" name="activityStreamUpdatedRecently" value="<?php echo $updatedRecently;?>" /> 
						<tr>
						  <td> <div  id ="filterOnEdit" style="height:<?php echo ($showDisplayInChatMode!='YES')?'144':'174'; ?>px;text-align:center;writing-mode: vertical-rl; transform: rotate(180deg);border-left:1px solid;margin-right:15px;">
                    ...
                    switchActivityStreamListUpdatedRecently();refreshActivityStreamList();
        				  ...
        				  <tr>
        						<td style="width:10%;white-space:nowrap;" align="right">
        							<?php echo pq_ucfirst(i18n('since'));?>&nbsp;
        						</td>
        						<td align="left">		
                      <div style="width:30px;<?php if (!isNewGui()) echo 'font-size:8pt;';?>" class="filterField rounded" dojoType="dijit.form.TextBox" value="<?php echo $activityStreamNumberDays;?>"
                       type="text" id="activityStreamNumberDays" name="activityStreamNumberDays" onChange="refreshActivityStreamList();">
      ...
      <tr style="margin-top:10px;">
          ...
          <td  style="padding:10px;white-space:nowrap;" align="right">
           <?php echo pq_ucfirst(i18n("showOnlyNotes"));?>
           <?php $displayShowOnlyNotes=($showOnlyNotes=='YES')?'inline-block':'none';?>
          </td>
          <td style="text-align:left;">
            ...
            <input type="hidden" id="lastShowOnlyNoteSwitch" name="lastShowOnlyNoteSwitch" value="<?php echo ($displayShowOnlyNotes=='inline-block')?'on':'off';?>" /> 
          </td>
       </tr>
       <tr style="margin-top:10px;">
          <input type="hidden" id="hideEmailsSentValue" name="hideEmailsSentValue" value="<?php echo $hideEmailsSent;?>" /> 
          <td  style="padding:10px;white-space:nowrap;" align="right">
           <?php echo pq_ucfirst(i18n("hideEmailsSent"));?>
           <?php $displayHideEmailsSent=($hideEmailsSent=='YES')?'inline-block':'none';?>
          </td>
          <td style="text-align:left;">
            <div  id="hideEmailsSentSwitch" name="hideEmailsSentSwitch" class="colorSwitch" data-dojo-type="dojox/mobile/Switch" value="<?php if($displayHideEmailsSent=='inline-block'){?>on<?php }else{?>off<?php }?>" leftLabel="" rightLabel="">
              <script type="dojo/method" event="onStateChanged" >
              hideEmailsSentStream();
              </script>
            </div>
            <input type="hidden" id="lastHideEmailsSentSwitch" name="lastHideEmailsSentSwitch" value="<?php echo ($displayShowOnlyNotes=='inline-block')?'on':'off';?>" /> 
          </td>
       </tr>
       <tr id="trDisplayChat" style="margin-top:10px;display:<?php echo ($showOnlyNotes=='YES' and $selectedAuthor)?"table-row;":"none;"; ?>">
          <input type="hidden" id="displayInChatMode" name="displayInChatMode" value="<?php echo ($displayInChatMode=='YES')?'on':'off';?>" /> 
          <td  style="padding:10px;white-space:nowrap;<?php echo $displayShowOnlyNotes;?>" align="right">
           <?php echo pq_ucfirst(i18n("displayInChatMode"));?>
          </td>
          <td style="text-align:left;">
            <div  id="displayInChatModeSwitched" name="displayInChatModeSwitched" class="colorSwitch" data-dojo-type="dojox/mobile/Switch" value="<?php echo ($displayInChatMode=='YES')?'on':'off';?>" style="<?php echo ($showDisplayInChatMode=='YES')?"table-row":"none";?>" leftLabel="" rightLabel="">
              <script type="dojo/method" event="onStateChanged" >
                displayInChatMode();
              </script>
            </div>

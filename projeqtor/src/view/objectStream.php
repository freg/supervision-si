...
<?php 
     ...
     $paramHeightStream=getContentPaneSize('contentPaneRightDetailDivHeight'.$objectClassStream);
     //$paramWidthStream=getContentPaneSize('contentPaneRightDetailDivWidth'.$objectClassStream);

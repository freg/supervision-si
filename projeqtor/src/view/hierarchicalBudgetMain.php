...
if ($positonRightDiv=="bottom") {
  $rightHeightHierarchicalBudget=getHeightLayoutActivityStream($currentScreen);
} else {
        ...
        <table style="float: right; margin-right: 5px">
              <tr>
                <td><label for="showFullAmount" class="Label"
                  style="white-space:nowrap;text-shadow: 0px 0px; margin-left: 5px; width: 200px; text-align:right"><?php echo pq_ucfirst(i18n('showFullAmount'));?>&nbsp;</label>
                </td>
                <td>

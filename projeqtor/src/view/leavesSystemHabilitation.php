                ...
                <td width="50px">
                    <button id="saveParameterButton" dojoType="dijit.form.Button"
                        ...
                        <script type="dojo/connect" event="onClick" args="evt">
                            submitForm("../tool/saveLeavesSystemHabilitation.php"+addTokenIndexToUrl('?'),"resultDivMain", "LeavesSystemHabilitationForm", true);
                        </script>
                    </button>
        ...
        <form dojoType="dijit.form.Form" id="LeavesSystemHabilitationForm" jsId="LeavesSystemHabilitationForm"
            ...
            <?php
                ...
                foreach ($habilitationList as $key => $hab) {
                    $class = pq_substr($hab->menuName,4);
            ...
            <div id="title<?php echo $hab->menuName; ?>" 
                ...
                <table style="width:96%; margin-left:2%; text-align:center;">
                    ...
                    <tr style="height: 20px;">
                        ...
                        <?php if (  $hab->menuName == 'menuDashboardEmployeeManager') {?>
                        <td class="tabLabel" style="text-align:center; width: 15%;"><?php echo i18n("seeAllAbsences");?></td>
                        <?php } else if (  $hab->menuName == 'menuLeaveCalendar') {?>
...
<?php
    function drawHabililitation($menuName, $type, $item, $vCRUD) {
        ...
        if (($menuName=="menuLeaveCalendar" or $menuName=="menuDashboardEmployeeManager") and $vCRUD!="viewAccess" and $vCRUD!="seeAllAccess") {
            $hide=true;
        }

...
$height=($showOnlyNotes=='YES' and $selectedAuthor)?"186":"156";
...
<div dojoType="dijit.layout.BorderContainer" class="container" style="overflow-y:auto;width:100%;">
	...
	<div dojoType="dijit.layout.ContentPane" id="activityStreamParameterDiv" class="listTitle" style="z-index: 3; overflow: visible;width:100%;height:<?php echo $height.'px'?>;" region="top">

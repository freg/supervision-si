...
class StatusMail extends SqlElement {
  ...
  public $isProject;
  public $mailToselectedReceivers;
  ...
  private static $_fieldsAttributes=array("idMailable"=>"", 
                                  ...
                                  "mailToselectedReceivers"=>"invisible,calculated"
  ...
  public function setAttributes() {
    if ($this->id) {
      ...
      if ($mailable=="Project") {
        ...
        self::$_fieldsAttributes['alertToManager']="invisible";
        self::$_colCaptionTransposition['mailToResource']="mailToManager";
        self::$_colCaptionTransposition['alertToResource']="mailToManager";
      }
    } 
  ...
  public function control() {
    ...
    if (!pq_trim($this->idStatus) and !pq_trim($this->idEventForMail)) {

...
class CallForTenderMain extends SqlElement {
  ...
  public $idUser;
  public $creationDate;
  public $_tab_2_1 = array('','', 'maxAmount');
  public $maxAmount;
  public $maxAmountLocal;
  public $deliveryDate;
  public $description;
  ...
  function drawTenderSubmissionsFromObject($readOnly=false) {
    ...
    foreach ( $tenderList as $tender ) {
      ...
      if (Parameter::getGlobalParameter('ImputOfAmountProvider')=='TTC') { 
        ...
        $tenderAmountLocal=($tender->totalFullAmountLocal)?$tender->totalFullAmountLocal:$tender->fullAmountLocal;
      } else {
        $tenderAmount=($tender->totalUntaxedAmount)?$tender->totalUntaxedAmount:$tender->untaxedAmount;
        $tenderAmountLocal=($tender->totalUntaxedAmountLocal)?$tender->totalUntaxedAmountLocal:$tender->untaxedAmountLocal;
      } 
      echo '<br/><span style="white-space:nowrap;font-size:90%;color:#555555"><i>'.htmlDisplayLocalCurrency($tender->idProject,$tenderAmount,$tenderAmountLocal,false).'</i></span>';
      echo '</td>';
      echo '</tr>';
    }
    echo '<tr>';

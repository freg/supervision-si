...
/* ============================================================================
 * ProspectType defines the type of a prospect.
 * Fields are declared explicitly rather than inherited from Type : the _lib_
 * label properties are commented out there, which leaves the behavior section
 * with unlabelled checkboxes.
 */
require_once('_securityCheck.php');
class ProspectType extends SqlElement {
  ...
  private static $_databaseCriteria = array('scope'=>'Prospect');

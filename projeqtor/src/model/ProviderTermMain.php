...
class ProviderTermMain extends SqlElement {
  ...
  public $idResource;
  public $_sec_Price;
  public $_tab_4_2_smallLabel = array('untaxedAmountShort', 'tax', '', 'fullAmountShort','initial','initialLocal');
...
//  	      $amountHTLocal = $this->untaxedAmountLocal;
//  	      $amountTTCLocal=$this->fullAmountLocal;
...
//  	      $pB->untaxedAmountLocal = $amountHTLocal;
//  	      $pB->fullAmountLocal =$amountTTCLocal;
//  	    }else{
//  	      $pB->untaxedAmount=$this->untaxedAmount;
//  	      $pB->fullAmount=$this->fullAmount;
//  	      $pB->taxPct= $this->taxPct;
//  	      $pB->taxAmount = $this->taxPct;
//  	      $pB->untaxedAmountLocal=$this->untaxedAmountLocal;
//  	      $pB->fullAmountLocal=$this->fullAmountLocal;
//  	      $pB->taxPctLocal= $this->taxPctLocal;
//  	      $pB->taxAmountLocal = $this->taxPctLocal;
//  	    }
//     $pB->save();
	  } else {
	    $this->isBilled=0;
  ...
  public function copyTo($newClass, $newType, $newName, $newProject, $setOrigin, $withNotes, $withAttachments, $withLinks, $withAssignments = false, $withAffectations = false, $toProject = NULL, $toActivity = NULL, $copyToWithResult = false, $copyToWithActivityPrice=false, $copyToWithStatus = false, $copyToWithSubTask=false, $moveAfterCreate=null) {
    if($newClass=='ProviderBill' and $this->idProviderBill){
      ...
      $newObj =  parent::copyTo($newClass, $newType, $newName, $newProject, $setOrigin, $withNotes, null, $withLinks, $withAssignments, $withAffectations, $toProject, $toActivity, $copyToWithResult, $copyToWithActivityPrice, $copyToWithStatus, false, $moveAfterCreate);
  ...
  public function updatePaidFlag() {
    ...
    $pmtSumLocal=$pmt->sumSqlElementsFromCriteria('paymentAmountLocal', array('idProviderTerm'=>$this->id));
    $pmtSum = $pmtSum ?: 0;
    $pmtSumLocal = $pmtSumLocal ?: 0;
    if (($this->fullAmount!= null and $pmtSum >= $this->fullAmount) or ($this->fullAmountLocal!=null and $pmtSumLocal>=$this->fullAmountLocal)) $this->isPaid=1;
    else $this->isPaid=0;
    $this->simpleSave();
  } 

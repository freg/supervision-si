...
/** =========================================================================
  ...
  public function control(){
    ...
    } else if (pq_trim($this->idTestCase)){
      $parentList=array();
    ...
    if (pq_trim($this->idTestCase)) {
      $parent=new TestCase($this->idTestCase);
      if ( pq_trim($this->idProduct)) {
        if (pq_trim($parent->idProduct)!=pq_trim($this->idProduct)) {
      	  $result.='<br/>' . i18n('msgParentTestCaseInSameProjectProduct');
        }
      } else {
      	if (pq_trim($parent->idProject)!=pq_trim($this->idProject)) {
          $result.='<br/>' . i18n('msgParentTestCaseInSameProjectProduct');
        }
      }
    }    
  ...
  public function save() {
  	if (! pq_trim($this->idRunStatus) or ! $this->id) $this->idRunStatus=5;
  ...
  public function drawCalculatedItem($item){
    ...
    if ($item=='runStatus') {
    	 ...
    	 if ($this->idRunStatus) {
	    	 ...
	    	 $result.='<td><img src="../view/css/images/icon'.pq_ucfirst($name).'22.png" /></td>';
	    	 $result.='<td style="width:5px;">&nbsp;</td>';

...
class ClientContractMain extends SqlElement {
  ...
  public $_sec_WorkTokenClientContract;
  public $_WorkTokenClientContract=array(); //table of workToken
  public $_workTokenClientContract_colSpan="2";
  public $_tab_3_1=array('ordered', 'used' , 'left','tokenTotal');
  public $tokenOrdered;
  public $tokenUsed;
  public $tokenLeft;
  ...
  public function setAttributes() {
    ...
    if(!Module::isModuleActive('moduleTokenManagement') ){
      self::$_fieldsAttributes ['_WorkTokenClientContract'] = 'hidden';
      self::$_fieldsAttributes ['_sec_WorkTokenClientContract'] = 'hidden';
      unset($this->_sec_WorkTokenClientContract);
    }
  }
// ============================================================================**********
...
// ============================================================================**********
  ...
  public function getValidationScript($colName) {
    ...
    if ($colName=='startDate') {
      ...
      $colScript .= '      url: "../tool/getSingleData.php?dataType=contactPhone&idContact=" + this.value+addTokenIndexToUrl(),';
  ...
  public function control(){
    ...
    if(Module::isModuleActive('moduleTokenManagement') and $this->id and $this->idProject!=$old->idProject){
      $workTokenCC=new WorkTokenClientContract();
      $nbWTCC=$workTokenCC->countSqlElementsFromCriteria(null,"idClientContract=$this->id and fullyConsumed!=1");
      if($nbWTCC > 0){

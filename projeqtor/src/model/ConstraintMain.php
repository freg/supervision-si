...
class ConstraintMain extends SqlElement {
  ...
  private static $_layout='
   ...
   private static $_databaseTableName = 'constrainttable';
  ...
  /** ==========================================================================
	...
	public function save() {
	  if (SqlElement::isCopyInProgress()) {
	    if (! $this->idSeverity) $this->idSeverity=SqlList::getFirstId('Severity');
	    if (! $this->idLikelihood) $this->idLikelihood=SqlList::getFirstId('Likelihood');
	  }
	  $result = parent::save();
	  return $result;
	} 

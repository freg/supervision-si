...
// TCPDF 6.11 declares cURL constants in class constants. Keep local PDF
// generation working on installations where the PHP curl extension is absent.
$tcpdfCurlConstants = array(
...
foreach ($tcpdfCurlConstants as $constantName => $constantValue) {
    if (!defined($constantName)) {
        define($constantName, $constantValue);
    }
}
unset($constantName, $constantValue, $tcpdfCurlConstants);

...
export const connectVendor = (b, t, name) => call(b, t, `/vendors/${encodeURIComponent(name)}/connect`, { method: "POST" });
export const connectStatus = (b, t, name) => call(b, t, `/vendors/${encodeURIComponent(name)}/connect/status`, { method: "POST" });
export const disconnectVendor = (b, t, name) => call(b, t, `/vendors/${encodeURIComponent(name)}/disconnect`, { method: "POST" });

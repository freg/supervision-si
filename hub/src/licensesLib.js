...
export const GAP_LABEL = {
  ...
  "user-former": "ancien avec licences", "user-former-active": "ancien (fiche) mais compte actif", "user-missing": "absent de l'annuaire", "user-disabled": "compte désactivé", "user-unknown": "hors annuaire",
};

...
class PluginTests(unittest.TestCase):
    ...
    def test_plugins_livres_valides(self):
        ...
        self.assertEqual(ids, ["broadcast-probe", "capture-relay", "docker-containers", "network-neighbors", "path-probe", "proxmox", "software-inventory", "web-audit", "web-trace", "wifi-probe", "windows-probe"])  # #436 relais ; #487 Proxmox ; #525 wifi-probe ; #527 path-probe ; #567 windows/broadcast ; #595 software-inventory
        for pid in ids:
